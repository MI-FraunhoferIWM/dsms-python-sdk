...
def _get_linked_diffs(
    ...
    from dsms.knowledge.properties.linked_kitems import GeneratedBy
    ...
    new_linked = [
        {
            ...
            "iri": new_kitem.iri,
            "generated_by": new_kitem.generated_by,
        ...
        if attr not in old_linked:
            if attr["generated_by"] in (
                ...
                warnings.warn(
                    ...
                    was generated by the custom properties .
                    Adding this link will be ignored during commit.
                    Please add the link in the custom properties."""
                )
            elif attr["is_incoming"] is True:
                warnings.warn(
        ...
        if attr not in new_linked:
            if attr["generated_by"] in (
                ...
                warnings.warn(
                    f"""Link between KItem with id {new_kitem.id} with relation
                    `{attr["iri"]}` to KItem with {attr["id"]}
                    was generated by the custom properties and is scheduled to be unlinked.
                    Deleting this link will be ignored during commit.
                    Please edit the link in the custom properties."""
                )
            elif attr["is_incoming"] is True:
                warnings.warn(
                    f"""KItem with id {new_kitem.id} linked with relation
